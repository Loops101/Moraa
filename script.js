// ==================== Configuration ====================
const YOUTUBE_VIDEO_ID = 'r0c9Q21AfLA'; // Replace with your desired YouTube video ID
...
yesBtn.addEventListener('click', () => {
    ...
    if (bgMusic) {
        bgMusic.play().catch(err => console.log('Audio autoplay prevented. User interaction needed sometimes.'));
    }
...
function launchConfetti() {
    ...
    const colors = ['#ff4d6d', '#ff8fa3', '#fff0f3', '#c9184a', '#ffd700', '#eee'];
